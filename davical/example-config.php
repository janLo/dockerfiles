...
*/
$c->pg_connect[] = "dbname={$container_db_name} user={$container_db_user} host={$container_db_host} password={$container_db_password}";
...
*/
$c->admin_email ='calendar-admin@'.$ENV["DAVICAL_SERVER_NAME"];
